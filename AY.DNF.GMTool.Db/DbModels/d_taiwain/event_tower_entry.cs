...
namespace AY.DNF.GMTool.Db.DbModels.d_taiwan
{
	...
	/// 
	/// </summary>
	[SugarTable("event_tower_entry", TableDescription = "")]
	public class EventTowerEntry
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "occ_check" , ColumnDataType = "int", DefaultValue = "0", ColumnDescription = "")]
		public int OccCheck { get; set; }
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "item3_no" , ColumnDataType = "int", DefaultValue = "0", ColumnDescription = "")]
		public int Item3No { get; set; }

		/// <summary>
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "item3_check" , ColumnDataType = "int", DefaultValue = "0", ColumnDescription = "")]
		public int Item3Check { get; set; }
