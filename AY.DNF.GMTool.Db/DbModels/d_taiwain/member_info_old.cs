...
namespace AY.DNF.GMTool.Db.DbModels.d_taiwan
{
	...
	/// 
	/// </summary>
	[SugarTable("member_info_old", TableDescription = "")]
	public class MemberInfoOld
	{
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "user_id" , ColumnDataType = "varchar", Length = 15, IsNullable = true, ColumnDescription = "")]
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "first_ssn" , ColumnDataType = "varchar", Length = 10, IsNullable = true, ColumnDescription = "")]
		public string? FirstSsn { get; set; }

		/// <summary>
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "second_ssn" , ColumnDataType = "varchar", Length = 10, IsNullable = true, ColumnDescription = "")]
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "mobile_no" , ColumnDataType = "varchar", Length = 8, ColumnDescription = "")]
