...
namespace AY.DNF.GMTool.Db.DbModels.taiwan_cain
{
	...
	/// 
	/// </summary>
	[SugarTable("party_rank_avg", TableDescription = "")]
	public class PartyRankAvg
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "party_level" , ColumnDataType = "smallint", IsPrimaryKey = true, DefaultValue = "0", ColumnDescription = "")]
