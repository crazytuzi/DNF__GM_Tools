...
namespace AY.DNF.GMTool.Db.DbModels.taiwan_cain_2nd
{
	...
	/// 
	/// </summary>
	[SugarTable("letter_del", TableDescription = "")]
	public class LetterDel
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "letter_id" , ColumnDataType = "int", IsPrimaryKey = true, DefaultValue = "0", ColumnDescription = "")]
