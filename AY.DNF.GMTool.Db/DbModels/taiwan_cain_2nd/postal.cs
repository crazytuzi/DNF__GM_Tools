...
namespace AY.DNF.GMTool.Db.DbModels.taiwan_cain_2nd
{
	...
	/// 
	/// </summary>
	[SugarTable("postal", TableDescription = "")]
	public class Postal
	{
		/// <summary>
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "postal_id" , ColumnDataType = "int", IsPrimaryKey = true, IsIdentity = true, ColumnDescription = "")]
