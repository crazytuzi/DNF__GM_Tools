...
namespace AY.DNF.GMTool.Db.DbModels.taiwan_cain_2nd
{
	...
	/// 
	/// </summary>
	[SugarTable("user_items_del", TableDescription = "")]
	public class UserItemsDel
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "ui_id" , ColumnDataType = "int", IsPrimaryKey = true, DefaultValue = "0", ColumnDescription = "")]
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "jewel_socket" , ColumnDataType = "varbinary", ColumnDescription = "")]
		...
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "color1" , ColumnDataType = "smallint", DefaultValue = "0", ColumnDescription = "")]
		public short Color1 { get; set; }

		/// <summary>
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "color2" , ColumnDataType = "smallint", DefaultValue = "0", ColumnDescription = "")]
		public short Color2 { get; set; }

		/// <summary>
		/// 
		/// </summary>
		[SugarColumn(ColumnName = "trade_restrict" , ColumnDataType = "tinyint", DefaultValue = "0", ColumnDescription = "")]
		public long TradeRestrict { get; set; }
